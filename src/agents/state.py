...
class AgentState(TypedDict, total=False):
    ...
    # ===== 路由结果 =====
    question_type: str                  # technical_depth / project_followup / behavioral / system_design / general
